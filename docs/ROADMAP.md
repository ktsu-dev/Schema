...
- **Editor tests** — `tests/Schema.Editor.UITests` drives the editor headlessly through
...
`tests/Schema.Editor.UITests` ([#128](https://github.com/ktsu-dev/Schema/issues/128)) drives the editor
